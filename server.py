...
from project_3_tester import post_with_username_pass
...
while True:
    ...
    currUsername = body["username"]
    currPassword = body["password"]
    currSecret = body["secret"]
    ...
    if(currUsername not in passwords or passwords[currUsername] != currPassword):
      html_content_to_send = bad_creds_page
    
    # But other possibilities exist, including
    elif(passwords[currUsername] == currPassword):
        html_content_to_send = success_page + currSecret
